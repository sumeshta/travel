...
@if(!empty($row->duration) or !empty($row->category_tour->name) or !empty($row->max_people) or !empty($row->location->name))
    ...
    <div class="row">
           ...
           <?php if(!empty($row->days) || !empty($row->nights)  || !empty($row->duration)){?>
       ...
       <?php } ?>
        ...
        @endif
             ...
             <?php if(!empty($row->departure) || !empty($row->destination)) {?> 
            <div class="col-xs-6 col-lg-3 col-md-6">
                <div class="item">
                    <div class="icon">
                    ...
                    <div class="info">
                        <h4 class="name">Departure - Destination</h4>
                        <p class="value"> 
            <?php if(!empty($row->departure)) {echo  $row->departure; } ?>  - 
            <?php if(!empty($row->destination)) {echo  $row->destination; } ?> 
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="social">
            <div class="social-share">
                ...
                <ul class="share-wrapper">
                    ...
                    <li> 
                        <a class="linkedin" href="https://www.linkedin.com/shareArticle?url={{$row->getDetailUrl()}}&amp;title={{$translation->title}}" target="_blank" rel="noopener" original-title="{{__("Twitter")}}">
                            <i class="fa fa-linkedin fa-lg"></i>
                        </a>
                    </li>
                    <li>
                        <a class="instagram" href="https://instagram.com/share?url={{$row->getDetailUrl()}}&amp;title={{$translation->title}}" target="_blank" rel="noopener" original-title="{{__("Twitter")}}">
