...
@section('content')
    <div class="bravo_search_space">
        <div class="bravo_banner" @if($bg = setting_item("space_page_search_banner")) style="background-image: url({{get_file_url($bg,'full')}});height:350px !important" @endif >
            <div class="container">
                <h1>
        ...
        <div class="bravo_form_search"  style="margin-top:0px !important">
            <div class="container">
                <div class="row">
