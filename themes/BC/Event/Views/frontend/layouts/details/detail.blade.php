        ...
        <div class="social">
            <div class="social-share">
                ...
                <ul class="share-wrapper">
                    ...
                    <li> 
                        <a class="linkedin" href="https://www.linkedin.com/sharing/share-offsite/?url={{$row->getDetailUrl()}}" target="_blank" rel="noopener" original-title="{{__("Twitter")}}">
                    ...
                    <!-- <li> 
                        <a class="linkedin" href="https://linkedin.com/sharing/share-offsite/?url={{$row->getDetailUrl()}}&amp;title={{$translation->title}}" target="_blank" rel="noopener" original-title="{{__("Twitter")}}">
                            <i class="fa fa-linkedin fa-lg"></i>
                        </a>
                    </li> -->
                    <li>
