        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" value="{{old('phone',$dataUser->phone)}}" name="phone" placeholder="{{__("Phone Number")}}" class="form-control bravo-intl-phone" autocomplete="tel">
                    <i class="fa fa-phone input-icon"></i>
                </div>
                <div class="form-group">
                    <label>{{__("Whatsapp Number")}}</label>
                    @php
                        $whatsappFull = old('whatsapp_full');
                        if ($whatsappFull === null) {
                            $waCode = preg_replace('/\D/', '', (string) ($dataUser->whatsapp_code ?? ''));
                            $waNum = preg_replace('/\D/', '', (string) ($dataUser->whatsapp ?? ''));
                            $whatsappFull = ($waCode || $waNum) ? '+' . $waCode . $waNum : '';
                        }
                    @endphp
                    <input type="tel" value="{{ $whatsappFull }}" name="whatsapp_full" class="form-control bravo-intl-phone bravo-intl-whatsapp" autocomplete="tel" placeholder="{{ __('Whatsapp Number') }}">
                    <input type="hidden" name="whatsapp_code" value="{{ old('whatsapp_code', $dataUser->whatsapp_code) }}">
                    <input type="hidden" name="whatsapp" value="{{ old('whatsapp', $dataUser->whatsapp) }}">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="map-google-url-field mt-3">
                        ...
                        <input type="url" name="map_google_url" class="form-control" value="{{old('map_google_url',$dataUser->map_google_url)}}" placeholder="https://www.google.com/maps/place/...">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{old('website',$dataUser->website)}}" name="website" placeholder="{{__("Website")}}" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{old('facebook',$dataUser->facebook)}}" name="facebook" placeholder="{{__("Facebook")}}" class="form-control">
                    <i class="fa fa-facebook input-icon"></i>
                </div>    
                
                <div class="form-group">
                    <label>{{__("Linkedin")}}</label>
                    <input type="text" value="{{old('linkedin',$dataUser->linkedin)}}" name="linkedin" placeholder="{{__("Linkedin")}}" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{old('instagram',$dataUser->instagram)}}" name="instagram" placeholder="{{__("Instagram")}}" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{old('youtube',$dataUser->youtube)}}" name="youtube" placeholder="{{__("Youtube")}}" class="form-control">
