...
class Space extends Bookable
{
    ...
    {
        $meta['seo_title'] = __("Search for Travel Agents");
    ...
    public function getNumberServiceInLocation($location)
    {
        ...
        if ($number > 1) {
            return __(":number Travel Agents", ['number' => $number]);
        }
        return __(":number Travel Agent", ['number' => $number]);
    }
    ...
    public function search($request)
    {
        ...
        Location::applyPublishedLocationFilter($query, 'bravo_spaces');
