...
class ManageSpaceController extends FrontendController
{
    ...
    public function manageSpace(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'         => __("Manage Travel Agent"),
        ];
    ...
    public function recovery(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'         => __("Recovery Travel Agent"),
        ];
        return view('Space::frontend.manageSpace.index', $data);
    }
    ...
    public function createSpace(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'         => __("Create Travel Agent"),
        ];
    ...
    public function store( Request $request, $id ){
        ...
        if ($res) {
            ...
            if($id > 0 ){
                ...
                return back()->with('success',  __('Travel Agent updated') . $pendingMsg);
            }else{
                event(new CreatedServicesEvent($row));
                return redirect(route('space.vendor.edit',['id'=>$row->id]))->with('success', __('Travel Agent created') . $pendingMsg);
            }
        }
    }
    ...
    public function editSpace(Request $request, $id)
    {
        ...
        $row = $row->find($id);
        if (empty($row)) {
            return redirect(route('space.vendor.index'))->with('warning', __('Travel Agent not found!'));
        }
        ...
        $data = [
            ...
            'page_title'         => __("Edit Travel Agent"),
        ];
        return view('Space::frontend.manageSpace.detail', $data);
    }
    ...
    public function deleteSpace($id)
    {
        ...
        return redirect(route('space.vendor.index'))->with('success', __('Delete Travel Agent success!'));
    }
	...
	public function cloneSpace(Request $request,$id){
		...
		try{
			...
			return redirect()->back()->with('success',__('Travel Agent clone was successful'));
